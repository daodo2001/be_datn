...
public class ConfigVnPay {
    ...
    public static String vnp_Returnurl = "http://localhost:3000/thong-tin-thanh-toan";
    public static String vnp_TmnCode = "BYIKGBKM";
    public static String vnp_HashSecret = "NSIVFBNYJNPTIQFUVMILAJUJXYHUITLH";
